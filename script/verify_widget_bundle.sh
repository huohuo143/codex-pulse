...
APP_BUNDLE="${1:-$ROOT_DIR/result/widgets-v2.5.2/build/Codex 脉动.app}"
...
assert_equal "$(/usr/libexec/PlistBuddy -c 'Print :CFBundleShortVersionString' "$APP_INFO")" "2.5.2" "App version"
...
assert_equal "$(/usr/libexec/PlistBuddy -c 'Print :CFBundleShortVersionString' "$WIDGET_INFO")" "2.5.2" "Widget version"
