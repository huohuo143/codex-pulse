...
APP_BUNDLE="${1:-$ROOT_DIR/dist/build-v2.9.0-build291/Codex 脉动.app}"
...
assert_equal "$(/usr/libexec/PlistBuddy -c 'Print :CFBundleShortVersionString' "$APP_INFO")" "2.9.0" "App version"
assert_equal "$(/usr/libexec/PlistBuddy -c 'Print :CFBundleVersion' "$APP_INFO")" "291" "App build"
...
assert_equal "$(/usr/libexec/PlistBuddy -c 'Print :CFBundleShortVersionString' "$WIDGET_INFO")" "2.9.0" "Widget version"
assert_equal "$(/usr/libexec/PlistBuddy -c 'Print :CFBundleVersion' "$WIDGET_INFO")" "291" "Widget build"
