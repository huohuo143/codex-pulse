...
APP_BUNDLE="${1:-$ROOT_DIR/dist/build-v2.5.4/Codex 脉动.app}"
...
assert_equal "$(/usr/libexec/PlistBuddy -c 'Print :CFBundleShortVersionString' "$APP_INFO")" "2.5.4" "App version"
...
assert_equal "$(/usr/libexec/PlistBuddy -c 'Print :CFBundleShortVersionString' "$WIDGET_INFO")" "2.5.4" "Widget version"
